...
/* package sudoku-gloss-0.1.0.0 */
#ifndef VERSION_sudoku_gloss
#define VERSION_sudoku_gloss "0.1.0.0"
#endif /* VERSION_sudoku_gloss */
#ifndef MIN_VERSION_sudoku_gloss
#define MIN_VERSION_sudoku_gloss(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_sudoku_gloss */
...
#define CURRENT_COMPONENT_ID "sudoku-gloss-0.1.0.0-inplace-sudoku-gloss"
